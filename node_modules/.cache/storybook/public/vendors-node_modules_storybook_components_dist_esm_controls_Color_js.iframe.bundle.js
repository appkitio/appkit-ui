(self["webpackChunkappkit_ui"] = self["webpackChunkappkit_ui"] || []).push([["vendors-node_modules_storybook_components_dist_esm_controls_Color_js"],{
...
/* harmony import */ var color_convert__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! color-convert */ "./node_modules/@storybook/components/node_modules/color-convert/index.js");
/* harmony import */ var color_convert__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(color_convert__WEBPACK_IMPORTED_MODULE_16__);
...
/* harmony import */ var _storybook_theming__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @storybook/theming */ "./node_modules/@storybook/theming/dist/esm/index.js");
...
/* harmony import */ var _tooltip_lazy_WithTooltip__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../tooltip/lazy-WithTooltip */ "./node_modules/@storybook/components/dist/esm/tooltip/lazy-WithTooltip.js");
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../form */ "./node_modules/@storybook/components/dist/esm/form/index.js");
/* harmony import */ var _icon_icon__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../icon/icon */ "./node_modules/@storybook/components/dist/esm/icon/icon.js");
...
var Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled.div({
  position: 'relative',
  maxWidth: 250
});
var PickerTooltip = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled)(_tooltip_lazy_WithTooltip__WEBPACK_IMPORTED_MODULE_19__.WithTooltip)({
  position: 'absolute',
  zIndex: 1,
  top: 4,
  left: 4
});
var TooltipContent = _storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled.div({
  width: 200,
  margin: 5,
...
var Note = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled)(_tooltip_TooltipNote__WEBPACK_IMPORTED_MODULE_20__.TooltipNote)(function (_ref) {
  var theme = _ref.theme;
  return {
    fontFamily: theme.typography.fonts.base
  };
});
var Swatches = _storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled.div({
  display: 'grid',
...
var SwatchColor = _storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled.div(function (_ref2) {
...
var Swatch = function Swatch(_ref3) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(SwatchColor, _extends({}, props, {
    active: active,
    onClick: onClick,
...
var Input = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled)(_form__WEBPACK_IMPORTED_MODULE_21__.Form.Input)(function (_ref4) {
...
var ToggleIcon = (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_18__.styled)(_icon_icon__WEBPACK_IMPORTED_MODULE_22__.Icons)(function (_ref5) {
...
var ColorPicker = (_ColorPicker = {}, _defineProperty(_ColorPicker, ColorSpace.HEX, react_colorful__WEBPACK_IMPORTED_MODULE_23__.HexColorPicker), _defineProperty(_ColorPicker, ColorSpace.RGB, react_colorful__WEBPACK_IMPORTED_MODULE_23__.RgbaStringColorPicker), _defineProperty(_ColorPicker, ColorSpace.HSL, react_colorful__WEBPACK_IMPORTED_MODULE_23__.HslaStringColorPicker), _ColorPicker);
...
var parseValue = function parseValue(value) {
  ...
  if (RGB_REGEXP.test(value)) {
    ...
    var _ref6 = color_convert__WEBPACK_IMPORTED_MODULE_16___default().rgb.hsl([r, g, b]) || [0, 0, 0],
    ...
    return _ref8 = {
      valid: valid,
      value: value,
      keyword: color_convert__WEBPACK_IMPORTED_MODULE_16___default().rgb.keyword([r, g, b]),
      colorSpace: ColorSpace.RGB
    }, _defineProperty(_ref8, ColorSpace.RGB, value), _defineProperty(_ref8, ColorSpace.HSL, "hsla(".concat(h, ", ").concat(s, "%, ").concat(l, "%, ").concat(a, ")")), _defineProperty(_ref8, ColorSpace.HEX, "#".concat(color_convert__WEBPACK_IMPORTED_MODULE_16___default().rgb.hex([r, g, b]).toLowerCase())), _ref8;
  }
  ...
  if (HSL_REGEXP.test(value)) {
    ...
    var _ref9 = color_convert__WEBPACK_IMPORTED_MODULE_16___default().hsl.rgb([_h, _s2, _l]) || [0, 0, 0],
    ...
    return _ref11 = {
      valid: valid,
      value: value,
      keyword: color_convert__WEBPACK_IMPORTED_MODULE_16___default().hsl.keyword([_h, _s2, _l]),
      colorSpace: ColorSpace.HSL
    }, _defineProperty(_ref11, ColorSpace.RGB, "rgba(".concat(_r, ", ").concat(_g, ", ").concat(_b, ", ").concat(_a, ")")), _defineProperty(_ref11, ColorSpace.HSL, value), _defineProperty(_ref11, ColorSpace.HEX, "#".concat(color_convert__WEBPACK_IMPORTED_MODULE_16___default().hsl.hex([_h, _s2, _l]).toLowerCase())), _ref11;
  }

  var plain = value.replace('#', '');
  var rgb = color_convert__WEBPACK_IMPORTED_MODULE_16___default().keyword.rgb(plain) || color_convert__WEBPACK_IMPORTED_MODULE_16___default().hex.rgb(plain);
  var hsl = color_convert__WEBPACK_IMPORTED_MODULE_16___default().rgb.hsl(rgb);
  var mapped = value;
  ...
  if (mapped.startsWith('#')) {
    ...
    try {
      color_convert__WEBPACK_IMPORTED_MODULE_16___default().keyword.hex(mapped);
    } catch (e) {
      valid = false;
    }
  }
  ...
  return _ref12 = {
    valid: valid,
    value: mapped,
    keyword: color_convert__WEBPACK_IMPORTED_MODULE_16___default().rgb.keyword(rgb),
...
var getRealValue = function getRealValue(value, color, colorSpace) {
  ...
  if (!color.hex.startsWith('#')) {
    try {
      return "#".concat(color_convert__WEBPACK_IMPORTED_MODULE_16___default().keyword.hex(color.hex));
    } catch (e) {
...
var useColorInput = function useColorInput(initialValue, onChange) {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_15__.useState)(initialValue || ''),
      _useState2 = _slicedToArray(_useState, 2),
      value = _useState2[0],
      setValue = _useState2[1];

  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_15__.useState)(function () {
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_15__.useState)((color === null || color === void 0 ? void 0 : color.colorSpace) || ColorSpace.HEX),
      _useState6 = _slicedToArray(_useState5, 2),
      colorSpace = _useState6[0],
      setColorSpace = _useState6[1];

  var realValue = (0,react__WEBPACK_IMPORTED_MODULE_15__.useMemo)(function () {
    return getRealValue(value, color, colorSpace).toLowerCase();
  }, [value, color, colorSpace]);
  var updateValue = (0,react__WEBPACK_IMPORTED_MODULE_15__.useCallback)(function (update) {
  ...
  var cycleColorSpace = (0,react__WEBPACK_IMPORTED_MODULE_15__.useCallback)(function () {
...
var usePresets = function usePresets(presetColors, currentColor, colorSpace) {
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_15__.useState)(currentColor !== null && currentColor !== void 0 && currentColor.valid ? [currentColor] : []),
      _useState8 = _slicedToArray(_useState7, 2),
      selectedColors = _useState8[0],
      setSelectedColors = _useState8[1];

  var presets = (0,react__WEBPACK_IMPORTED_MODULE_15__.useMemo)(function () {
  ...
  var addPreset = (0,react__WEBPACK_IMPORTED_MODULE_15__.useCallback)(function (color) {
...
var ColorControl = function ColorControl(_ref13) {
  ...
  var _useColorInput = useColorInput(initialValue, lodash_throttle__WEBPACK_IMPORTED_MODULE_17___default()(onChange, 200)),
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(Wrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(PickerTooltip, {
    trigger: "click",
    startOpen: startOpen,
    closeOnClick: true,
    ...
    tooltip: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(TooltipContent, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(Picker, {
      color: realValue === 'transparent' ? '#000000' : realValue,
      onChange: updateValue,
      onFocus: onFocus,
      onBlur: onBlur
    }), presets.length > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(Swatches, null, presets.map(function (preset) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(_tooltip_lazy_WithTooltip__WEBPACK_IMPORTED_MODULE_19__.WithTooltip, {
        key: preset.value,
        hasChrome: false,
        tooltip: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(Note, {
          note: preset.keyword || preset.value
        })
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(Swatch, {
  ...
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(Input, {
    value: value,
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15__.createElement(ToggleIcon, {
    icon: "markup",
