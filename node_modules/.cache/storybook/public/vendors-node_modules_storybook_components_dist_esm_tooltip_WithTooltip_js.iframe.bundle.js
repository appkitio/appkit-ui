(self["webpackChunkappkit_ui"] = self["webpackChunkappkit_ui"] || []).push([["vendors-node_modules_storybook_components_dist_esm_tooltip_WithTooltip_js"],{
...
var Arrow = _storybook_theming__WEBPACK_IMPORTED_MODULE_8__.styled.div({
  ...
  return {
    ...
    borderTopColor: match('top', placement, theme.color[color] || color || theme.base === 'light' ? (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.darkenColor)(theme.background.app), 'transparent'),
    borderBottomColor: match('bottom', placement, theme.color[color] || color || theme.base === 'light' ? (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.darkenColor)(theme.background.app), 'transparent'),
    borderLeftColor: match('left', placement, theme.color[color] || color || theme.base === 'light' ? (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.darkenColor)(theme.background.app), 'transparent'),
    borderRightColor: match('right', placement, theme.color[color] || color || theme.base === 'light' ? (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.darkenColor)(theme.background.app), 'transparent')
  };
});
var Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_8__.styled.div(function (_ref3) {
  ...
  return hasChrome ? {
    background: theme.color[color] || color || theme.base === 'light' ? (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : (0,_storybook_theming__WEBPACK_IMPORTED_MODULE_9__.darkenColor)(theme.background.app),
...
var Tooltip = function Tooltip(_ref5) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6__.createElement(Wrapper, _extends({
    hasChrome: hasChrome,
    placement: placement,
    ref: tooltipRef
  }, props, {
    color: color
  }), hasChrome && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6__.createElement(Arrow, _extends({
    placement: placement,
    ref: arrowRef
  }, arrowProps, {
    color: color
...
/* harmony import */ var _storybook_theming__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @storybook/theming */ "./node_modules/@storybook/theming/dist/esm/index.js");
...
var TargetContainer = _storybook_theming__WEBPACK_IMPORTED_MODULE_6__.styled.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: inline-block;\n  cursor: ", ";\n"])), function (props) {
  return props.mode === 'hover' ? 'default' : 'pointer';
});
var TargetSvgContainer = _storybook_theming__WEBPACK_IMPORTED_MODULE_6__.styled.g(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  cursor: ", ";\n"])), function (props) {
  return props.mode === 'hover' ? 'default' : 'pointer';
});
...
var WithTooltipPure = function WithTooltipPure(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(react_popper_tooltip__WEBPACK_IMPORTED_MODULE_7__.default, {
    placement: placement,
    trigger: trigger,
    modifiers: modifiers,
    ...
    tooltip: function tooltip(_ref2) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(_Tooltip__WEBPACK_IMPORTED_MODULE_8__.Tooltip, _extends({
        hasChrome: hasChrome,
    ...
    return (
      /*#__PURE__*/
      // @ts-ignore
      react__WEBPACK_IMPORTED_MODULE_4__.createElement(Container, _extends({
        ref: triggerRef
...
var WithToolTipState = function WithToolTipState(_ref4) {
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(startOpen || false),
      _useState2 = _slicedToArray(_useState, 2),
      tooltipShown = _useState2[0],
      setTooltipShown = _useState2[1];

  var onVisibilityChange = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)(function (visibility) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(function () {
    ...
    global__WEBPACK_IMPORTED_MODULE_5__.document.addEventListener('keydown', hide, false); // Find all iframes on the screen and bind to clicks inside them (waiting until the iframe is ready)

    var iframes = Array.from(global__WEBPACK_IMPORTED_MODULE_5__.document.getElementsByTagName('iframe'));
    var unbinders = [];
    ...
    return function () {
      global__WEBPACK_IMPORTED_MODULE_5__.document.removeEventListener('keydown', hide);
      unbinders.forEach(function (unbind) {
        unbind();
      });
    };
  });
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(WithTooltipPure, _extends({}, rest, {
    tooltipShown: tooltipShown,
    onVisibilityChange: onVisibilityChange
  }));
};
